...
if __name__ == '__main__':
    ...
    if args.parallel:
        ...
        ppv_local, ppv_u_local = po.makeobservable(cube, args, logbook, properties, core_start, core_end, prefix) #performing operation on cube   
        ...
        time_temp = time.time()
        ppv, ppv_u = po.makeobservable(cube, args, logbook, properties, 0, nslice, '') #performing operation on cube   
        po.write_fits(logbook.fitsname, ppv, args)
        po.write_fits(logbook.fitsname_u, ppv_u, args)
