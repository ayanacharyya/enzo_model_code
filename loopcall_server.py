...
scale_exptime_arr = [240000,
                     480000]  # exp time for arc=0.5, pivoting which the exp time for other arc values would be determined
...
--arc ' + str(arc) + ' --scale_exptime ' + str(scale_exptime) + ' --file ' + file + ' --multi_realisation ' + str(
                        multi) + ' --path ' + outpath], shell=True)
